...
theme.wallpaper                                 = theme.dir .. "/gy65o4mk3oe01.png"
...
theme.langwidget = kbdcfg.widget
theme.langswitcher = kbdcfg

-- langicon:buttons(awful.util.table.join(awful.button({ }, 1, function () kbdcfg.switch() end)))
theme.langwidget:buttons(awful.util.table.join(awful.button({ }, 1, function () kbdcfg.switch() end)))
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
	    ...
	    arrl_ld,
	    wibox.container.background(langicon, theme.bg_focus),
	    wibox.container.background(theme.langwidget, theme.bg_focus),
	    arrl_dl,
            spr,
	    weathericon,
