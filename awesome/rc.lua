...
-- }}}
-- {{{ CUSTOM: default timeout for notifications
...
-- set the app folders used to populate the menubar
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey }, "Shift_L", function () kbdcfg.switch() end,
	    {description = "switch locale", group = "client"}),
    ...
    awful.key({ modkey, altkey }, "n",
        ...
        {description = "dismiss notifications on all screens"}),
--[[
    -- MPD control
...
awful.rules.rules = {
    ...
    { rule_any = { class = { "jetbrains-studio", "Subl3", "Atom", "Code" } },
      properties = { tag = "1" } },
    { rule_any = { class = { "Firefox", "Google Chrome", "Chrome", "Google-chrome-beta", "vivaldi-stable" } },
      properties = { tag = "2" } },
    { rule_any = { class = { "Termite", "Alacritty" } },
      properties = { tag = "3" } },
    { rule = { class = "Nautilus" },
      properties = { tag = "4" } },
    { rule_any = { class = { "qBittorrent", "smplayer", "Franz", "Slack", "ClickUp" } },
      properties = { tag = "5" } }
}
-- }}}
...
os.execute('xinput --set-prop --type=int --format=8  "SynPS/2 Synaptics TouchPad" "libinput Tapping Enabled" 1')
os.execute('nm-applet &')
os.execute('compton -b --config ~/.compton.conf')
